...
def on_row_select(event, frame, tree, student_no, l_id):
    ...
    if not df1.empty:
        ...
        header_label1.place(x=10, y=260)
    ...
    table4.place(x=10, y=300, height=total_height)
    ...
    if not df2.empty:
        ...
        header_label2.place(x=10, y=520)
    ...
    table5.place(x=10, y=550, height=total_height2)
